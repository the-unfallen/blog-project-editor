...
import { initAuth, generateHeader, authFetch, API_BASE } from "./auth2.js";
// import { formatDate } from "./myPosts.js";
import { formatDate } from "./utils.js";

const publishedPostsContainer = document.getElementById(
    "published-posts-container",
);

async function getPublishedPosts() {
    const postsURL = `${API_BASE}/posts/published`;
    ...
    try {
        ...
        for (const element of data) {
            ...
            if (publishedPostsContainer)
                publishedPostsContainer.appendChild(newDiv);
        }
    } catch (error) {
